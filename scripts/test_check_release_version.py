...
class CheckReleaseVersionTests(unittest.TestCase):
    def run_check(
        self, package_version: str, release_version: str, update: bool = False
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            return result, manifest_path.read_text(encoding="utf-8"), lock_text
    ...
    def test_update_synchronizes_manifest_and_lockfile(self) -> None:
        result, manifest, lockfile = self.run_check(
            "0.21.0-rc4", "0.21.0-rc5", update=True
        )
